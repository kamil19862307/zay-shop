...
@section('content')
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form action="{{ route('register_process') }}" class="col-md-8 m-auto" method="POST" role="form">
                @csrf
                ...
                <div class="row m-auto text-center">
                    <div class="form-group col-md-8 m-auto mb-3 @error('name') border-red-500 @enderror">
                        <input
                                type="text"
